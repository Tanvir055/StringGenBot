...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@feelingspeace"))
        else:
            ...
            await client.join_chat("feelingspeace")
    except KeyError:
        pass
    try:
